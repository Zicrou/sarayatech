...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference("Information.count") do
      post information_index_url, params: { information: { address: @information.address, first_name: @information.first_name, id_card: @information.id_card, last_name: @information.last_name, phone_number: @information.phone_number } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { address: @information.address, first_name: @information.first_name, id_card: @information.id_card, last_name: @information.last_name, phone_number: @information.phone_number } }
